...
module clk_fx(CLKIN_IN, 
   ...
   BUFG CLKFX_BUFG_INST (.I(CLKFX_BUF), 
                         .O(CLKFX_OUT));
   DCM_ADV DCM_ADV_INST_FX (.CLKFB(CLKFB_IN), 
                         .CLKIN(CLKIN_IN),
                         .DADDR(GND_BUS_7[6:0]), 
                         .DCLK(GND_BIT), 
                         .DEN(GND_BIT), 
   ...
   defparam DCM_ADV_INST_FX.DCM_AUTOCALIBRATION = "TRUE";
   defparam DCM_ADV_INST_FX.DCM_PERFORMANCE_MODE = "MAX_SPEED";
   ...
   defparam DCM_ADV_INST_FX.SIM_DEVICE = "VIRTEX5";
endmodule
