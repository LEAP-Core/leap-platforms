...
cfg_interrupt_di
  ...
  pcie_endpoint endpt( .cfg_pm_wake_n(cfg_pm_wake_n), .cfg_err_cpl_abort_n(cfg_err_cpl_abort_n), .trn_tsrc_rdy_n(trn_tsrc_rdy_n), .trn_terrfwd_n(trn_terrfwd_n), .cfg_to_turnoff_n(cfg_to_turnoff_n), .refclkout(refclkout), .trn_tdst_rdy_n(trn_tdst_rdy_n), .trn_rsrc_dsc_n(trn_rsrc_dsc_n), .trn_rnp_ok_n(trn_rnp_ok_n),
