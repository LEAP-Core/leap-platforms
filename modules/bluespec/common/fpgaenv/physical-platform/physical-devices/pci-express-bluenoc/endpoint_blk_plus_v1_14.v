...
cfg_interrupt_di
  ...
  pcie_endpoint_old endpt( .cfg_pm_wake_n(cfg_pm_wake_n), .cfg_err_cpl_abort_n(cfg_err_cpl_abort_n), .trn_tsrc_rdy_n(trn_tsrc_rdy_n), .trn_terrfwd_n(trn_terrfwd_n), .cfg_to_turnoff_n(cfg_to_turnoff_n), .refclkout(refclkout), .trn_tdst_rdy_n(trn_tdst_rdy_n), .trn_rsrc_dsc_n(trn_rsrc_dsc_n), .trn_rnp_ok_n(trn_rnp_ok_n),
.trn_tsrc_dsc_n(trn_tsrc_dsc_n), .cfg_err_cpl_unexpect_n(cfg_err_cpl_unexpect_n), .cfg_err_cor_n(cfg_err_cor_n), .cfg_wr_en_n(cfg_wr_en_n), .trn_rsrc_rdy_n(trn_rsrc_rdy_n), .cfg_err_locked_n(cfg_err_locked_n), .trn_tdst_dsc_n(trn_tdst_dsc_n), .trn_reset_n(trn_reset_n), .cfg_err_ur_n(cfg_err_ur_n),
.trn_rcpl_streaming_n(trn_rcpl_streaming_n), .cfg_interrupt_n(cfg_interrupt_n), .cfg_err_cpl_timeout_n(cfg_err_cpl_timeout_n), .trn_clk(trn_clk), .cfg_trn_pending_n(cfg_trn_pending_n), .fast_train_simulation_only(fast_train_simulation_only), .cfg_interrupt_msienable(cfg_interrupt_msienable),
.trn_lnk_up_n(trn_lnk_up_n), .trn_tsof_n(trn_tsof_n), .trn_reof_n(trn_reof_n), .cfg_rd_wr_done_n(cfg_rd_wr_done_n), .cfg_rd_en_n(cfg_rd_en_n), .sys_clk(sys_clk), .trn_rdst_rdy_n(trn_rdst_rdy_n), .trn_rerrfwd_n(trn_rerrfwd_n), .cfg_interrupt_rdy_n(cfg_interrupt_rdy_n),
.cfg_interrupt_assert_n(cfg_interrupt_assert_n), .trn_teof_n(trn_teof_n), .trn_rsof_n(trn_rsof_n), .cfg_err_posted_n(cfg_err_posted_n), .sys_reset_n(sys_reset_n), .cfg_err_cpl_rdy_n(cfg_err_cpl_rdy_n), .cfg_err_ecrc_n(cfg_err_ecrc_n), .pci_exp_txn(pci_exp_txn), .cfg_interrupt_do(cfg_interrupt_do),
.pci_exp_txp(pci_exp_txp), .trn_rbar_hit_n(trn_rbar_hit_n), .cfg_dstatus(cfg_dstatus), .cfg_function_number(cfg_function_number), .trn_rd(trn_rd), .trn_td(trn_td), .cfg_dsn(cfg_dsn), .cfg_interrupt_mmenable(cfg_interrupt_mmenable), .cfg_dcommand(cfg_dcommand), .trn_rfc_ph_av(trn_rfc_ph_av),
.trn_rfc_npd_av(trn_rfc_npd_av), .cfg_bus_number(cfg_bus_number), .trn_rrem_n(trn_rrem_n), .cfg_di(cfg_di), .cfg_dwaddr(cfg_dwaddr), .cfg_byte_en_n(cfg_byte_en_n), .cfg_do(cfg_do), .cfg_device_number(cfg_device_number), .cfg_lstatus(cfg_lstatus), .cfg_err_tlp_cpl_header(cfg_err_tlp_cpl_header),
.cfg_command(cfg_command), .cfg_pcie_link_state_n(cfg_pcie_link_state_n), .trn_tbuf_av(trn_tbuf_av), .pci_exp_rxn(pci_exp_rxn), .pci_exp_rxp(pci_exp_rxp), .cfg_lcommand(cfg_lcommand), .cfg_status(cfg_status), .trn_rfc_nph_av(trn_rfc_nph_av), .trn_trem_n(trn_trem_n), .trn_rfc_pd_av(trn_rfc_pd_av),
