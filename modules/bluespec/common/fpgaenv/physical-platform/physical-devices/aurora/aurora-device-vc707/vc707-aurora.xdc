...
proc auroraConstraints { } {
    ...
    foreach ifc [list 0 1] {
        ...
        annotateSafeClockCrossing [get_cells -hier -filter "NAME =~ *aurora_device/ug_device_${ifc}/aurora_64b66b_v7_3_block_i/aurora_64b66b_v7_3_wrapper_i/rxdata_to_fifo_i5_reg*"] [get_cells -hier -filter "NAME =~ *aurora_device/ug_device_${ifc}/aurora_64b66b_v7_3_block_i/aurora_64b66b_v7_3_wrapper_i/cbcc_gtx0_i/count_for_reset_r_reg*"]  
    ...
    if {[getAWBParams {"area_group_tool" "AREA_GROUPS_PAR_DEVICE_AG"}] != "1"} {
        ...
        resize_pblock pblock_aurora0 -add {SLICE_X170Y0:SLICE_X221Y49}
        ...
        resize_pblock pblock_aurora1 -add {SLICE_X170Y200:SLICE_X221Y249}
        set_property   gridtypes {RAMB36 RAMB18 DSP48 SLICE} [get_pblocks  pblock_aurora1]
